...
class Chunker:
    ...
    def chunk_text(self, text: Union[str, List[str], Tuple[str], List[Tuple[str]]]) -> List[str]:
        """
...
if __name__ == "__main__":
    ...
    sentences1 = chunker.chunk_text(text1)
    ...
    sentences2 = chunker.chunk_text(text2)
    print("\nChunker Example 2:")
    ...
    sentences3 = chunker.chunk_text(text3)
    print("\nChunker Example 3:")
